...
Die Informationen über den Sensor und die generierten Daten werden in einem Json-Objekt verpackt.
...
Falls ja, wird der HTTP-Code "200 OK" zurückgeschickt, anonsten den Fehler-Code "404 Not Found".
...
- Um die Laufzeit eines Zyklus zu messen, wird von jeder Message die Round Trip Time berechnet, sowie den Mittelwert alle 10 Messungen und in einen shared Folder gespeichert.
- Alle Systeme sind absturzsicher und können jederzeit ausgeschaltet werden und wieder eingeschaltet werden - das wiederverbinden passiert automatisch.
- Im IoT-Gateway wird jede 10. und 15. Message eine falsche Http-Post-Anfrage versendet. Als Rückmeldung vom Server erhalten wir Error-Code 404 Not Found.
